...
add_action('after_switch_theme', [Installer::class, 'activate']);
...
final class Theme {
    ...
    private function load_components() {
        ...
        $this->discount_manager = new DiscountManager($this->character_manager);
    ...
    private function define_hooks() {
        ...
        if (!is_admin()) {
            ...
            // Хуки для админ-панели (профиль и таблица пользователей)
     ...
     * Инициализирует RPG-данные для нового пользователя
     *
     * @param int $user_id Идентификатор зарегистрированного пользователя
     */
     ...
     * @return array Измененный набор пунктов
     */
    ...
    public function run_weekly_human_coupon_issuance_job() {
        ...
        // error_log('WoodmartChildRPG: Weekly Human coupon issuance job executed.');
    }
